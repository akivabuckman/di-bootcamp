...
from .views import BookingSuccess, create_booking, visitor_home_page, RegisterView, CustomLoginView, Booking
...
urlpatterns = [
    ...
    path('book/<str:date>', create_booking, name='create_booking'),
